...
export const createVueStructure = (): FileItem => ({
    id: "root",
    name: "vue-project",
    type: "folder",
    children: [
...
export const createAngularStructure = (): FileItem => ({
    id: "root",
...
export const createSvelteStructure = (): FileItem => ({
    id: "root",
    name: "svelte-project",
    type: "folder",
    children: [
...
export const createNuxtStructure = (): FileItem => ({
    id: "root",
    name: "nuxt-project",
    type: "folder",
    children: [
...
export const createRemixStructure = (): FileItem => ({
    id: "root",
    name: "remix-project",
    type: "folder",
    children: [
...
export const createAstroStructure = (): FileItem => ({
    id: "root",
    name: "astro-project",
    type: "folder",
    children: [
